...
<head>
    ...
    <link rel="stylesheet" href="../styles/ciclo-vida-sistema.css">
...
<body>
    ...
    <section class="tarea-sidebar">
        <article class="articule-tarea">
            <h2>El ciclo de desarrollo de un producto</h2>
            <hr>
            <p>Cada producto nuevo, sea una aplicación o un objeto físico, sigue una serie de pasos específicos que lo llevan desde la primera chispa de una idea hasta el lanzamiento del producto final. Esto se denomina ciclo de desarrollo del producto y tiene cinco etapas: lluvia de ideas, definición, diseño, prueba y lanzamiento. En función de dónde trabajes, los nombres exactos de cada etapa pueden ser un poco diferentes, pero el proceso general suele ser el mismo.</p>
            <ol>
                <li>
                    <h3>Lluvia de ideas</h3>
                    <p>La primera etapa del ciclo de desarrollo de un producto es la de lluvia de ideas, cuando el equipo empieza a pensar en una idea para un producto. En algunos casos, tú y tu equipo ya conocerán el problema del usuario que quieren resolver al empezar el ciclo de desarrollo del producto. Si no es así, crear una lista de problemas del usuario es un excelente punto de partida.
